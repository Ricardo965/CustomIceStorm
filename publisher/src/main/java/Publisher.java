// Generated Demo package will be available after slice compilation
import Demo.*;
...
public class Publisher {
    public static void main(String[] args) {
        ...
        try (com.zeroc.Ice.Communicator communicator = com.zeroc.Ice.Util.initialize(args, "config/config.pub", extraArgs)) {
